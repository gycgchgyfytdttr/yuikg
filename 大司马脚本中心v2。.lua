...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "大司马脚本中心V2"; Text ="启动中"; Duration = 2; })
        ...
        for _, player in pairs(game.Players:GetPlayers()) do
            if player ~= game.Players.LocalPlayer then
                if state then
                    ...
                    circle.Image = "rbxassetid://91822813356667" -- Replace with your circle image asset ID
                else
